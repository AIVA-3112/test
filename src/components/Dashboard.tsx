...
const Dashboard: React.FC<DashboardProps> = ({ onLogout, onSwitchAccount,onNavigateToHome, user,onNavigateHome}) => {
...
<div className={`flex-1 flex flex-col ${sidebarOpen ? 'ml-64' : 'ml-16'} h-screen transition-all duration-300`}>
        ...
        <header className="bg-slate-800 text-white p-4 flex items-center justify-between flex-shrink-0 sticky top-0 z-30">
          <div className="flex items-center space-x-3" onClick={()=>{user?onNavigateHome(user):null}}>
              ...
              {profileMenuOpen && (
                ...
                <button
                  onClick={() => {
                    ...
                    // Navigate to signup page within the app
                    onNavigateToHome();
                    // Brief delay to ensure page navigation, then open signup
                    setTimeout(() => {
                      onSwitchAccount(); // This will navigate to login page which has signup option
                    }, 100);
                  }}
                ...
                >
                 ...
                 <button
                  ...
                  <button
                    onClick={() => {
                      setProfileMenuOpen(false);
                      // Show collaboration features - for now, show an alert
